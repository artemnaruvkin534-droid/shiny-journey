...
# === ДОБАВЬТЕ ЭТУ ФУНКЦИЮ В САМОЕ НАЧАЛО ===
...
bg = pygame.image.load(resource_path("images/font.png")).convert_alpha()
walk_right = [
    pygame.image.load(resource_path("images/player_right/player_right1.png")).convert_alpha(),
    pygame.image.load(resource_path("images/player_right/player_right2.png")).convert_alpha(),
    pygame.image.load(resource_path("images/player_right/player_right3.png")).convert_alpha(),
    pygame.image.load(resource_path("images/player_right/player_right4.png")).convert_alpha(),
]
walk_left = [
    pygame.image.load(resource_path("images/player_left/player_left1.png")).convert_alpha(),
    pygame.image.load(resource_path("images/player_left/player_left2.png")).convert_alpha(),
    pygame.image.load(resource_path("images/player_left/player_left3.png")).convert_alpha(),
    pygame.image.load(resource_path("images/player_left/player_left4.png")).convert_alpha(),
]

ghost = pygame.image.load(resource_path("images/ghost.png")).convert_alpha()
bullet = pygame.image.load(resource_path("images/bullet.png")).convert_alpha()
...
while running:
    if game_state == MAIN_MENU:
        ...
        menu_button = pygame.Rect(510, 550, 200, 60)
